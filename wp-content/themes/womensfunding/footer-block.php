	...
	<div class="footer-columns center-wrap cf">
		<div class="column col-1">
			...
			<ul class="socials">				<?php foreach($socials as $soc){?>
				<li><a href="<?php echo $soc['link'];?>" target="_blank"><img src="<?php echo $soc['icon'];?>" height="40" width="40" alt=""></a></li>
				<?php } ?>
			</ul>
			<?php } ?>
...
<?php endif; ?>	
			...
			<div class="column col-3">
				...
				<a href="<?php the_field('join_wfn', 'option'); ?>" target="_blank" class="btn-red"><?php the_field('join_button_text', 'option'); ?></a>
			</div>
		</div>
